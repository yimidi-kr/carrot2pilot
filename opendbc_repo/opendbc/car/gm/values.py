...
class CAR(Platforms):
  ...
  # Now EQUINOX spec is to be CT6-2019 spec !!! by yimidi-kr 2025.05.23
...
CAMERA_ACC_CAR = {CAR.CHEVROLET_BOLT_EUV, CAR.CHEVROLET_SILVERADO, CAR.CHEVROLET_EQUINOX, CAR.CADILLAC_CT6_ACC, CAR.CHEVROLET_TRAILBLAZER, CAR.CHEVROLET_TRAX}
