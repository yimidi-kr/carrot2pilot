...
class CAR(Platforms):
  ...
  CADILLAC_CT6_2019 = GMPlatformConfig(   # GMCT6PlatformConfig(  
...
SDGM_CAR = {CAR.CADILLAC_XT4, CAR.CHEVROLET_MALIBU_2019, CAR.CHEVROLET_VOLT_2019, CAR.CHEVROLET_TRAVERSE}

# We're integrated at the camera with VOACC on these cars (instead of ASCM w/ OBD-II harness)
CAMERA_ACC_CAR = {CAR.CHEVROLET_BOLT_EUV, CAR.CHEVROLET_SILVERADO, CAR.CHEVROLET_EQUINOX, CAR.CADILLAC_CT6_2019, CAR.CHEVROLET_TRAILBLAZER, CAR.CHEVROLET_TRAX}
